...
- **Δωρεάν παράδοση από υπάλληλο της εταιρείας** — αυστηρά έως **3 εργάσιμες ημέρες**, μόνο
...
- **Courier** — πάντα διαθέσιμη επιλογή, **υποχρεωτική** αν η διεύθυνση είναι εκτός αυτής της
  περιοχής, έως **3 εργάσιμες ημέρες**.
- **BOX NOW locker** — παράδοση σε αυτόματο locker, έως **3 εργάσιμες ημέρες**.
